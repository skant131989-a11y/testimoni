      ...
      <main className="mx-auto max-w-7xl px-4 py-12">
        ...
        <div className="mt-12 grid gap-8 lg:grid-cols-2">
              ...
              {step === "form" ? (
                ...
                <div className="py-6 text-center">
                  ...
                  <p className="mt-2 text-muted-foreground">
                    Your testimonial is now live. Check it out below!
                  </p>
                  <div className="mt-4 flex items-center justify-center gap-2 text-primary">
                    <ArrowDown className="h-5 w-5 animate-bounce" />
                    <span className="text-sm font-medium">Scroll down to see it</span>
                  </div>
          ...
          <div>
            ...
            <p className="mb-4 text-sm text-muted-foreground">
              New submissions appear here. One click to approve, and it goes live on your site.
            </p>
            ...
            <div className="rounded-2xl border bg-card p-4 shadow-sm">
              <div className="mb-3 flex items-center justify-between">
                ...
                <Badge variant="secondary">{testimonials.filter((t) => t.isNew).length} new</Badge>
              </div>
                ...
                {testimonials.slice(0, 5).map((t, i) => (
                  ...
                  >
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <p className="truncate text-xs text-muted-foreground">{t.content}</p>
                    ...
                    <Button
                      size="sm"
                      variant={t.isNew ? "default" : "outline"}
                      className="shrink-0 text-xs"
                    >
                      <CheckCircle2 className="mr-1 h-3 w-3" />
                      {t.isNew ? "Approve" : "Approved"}
                    </Button>
                  </div>
                ))}
              </div>
