...
export default function SignupPage() {
  ...
  return (
    <Card>
      ...
      <CardContent>
        {/* Google — primary path. Big, colorful, first. */}
        <Button
          type="button"
          size="lg"
          className="w-full gap-2 border-2 border-slate-200 bg-white text-slate-900 hover:bg-slate-50 hover:text-slate-900"
        ...
        {/* Email + password — always visible, secondary */}
