      ...
      {magicSent ? (
        <>
          ...
          <CardContent className="space-y-4">
            ...
            {/* OTP code input — bypasses the magic-link scanner
                problem. Users can type the 6-digit code from the
                email instead of clicking the link. */}
            <OtpCodeInput
              email={email}
              redirectTo="/dashboard"
              successEvent="login_completed"
              method="magic_link"
              surface="login"
            />
